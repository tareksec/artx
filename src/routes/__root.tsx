...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArtX — Creative studio for design, development & SEO" },
      { name: "description", content: "ArtX is an independent studio designing, building and ranking standout websites for brands that refuse to blend in." },
      { name: "author", content: "ArtX Studio" },
      { property: "og:site_name", content: "ArtX" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "ArtX — Creative studio for design, development & SEO" },
      { property: "og:description", content: "ArtX is an independent studio designing, building and ranking standout websites for brands that refuse to blend in." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ArtX — Creative studio for design, development & SEO" },
      { name: "twitter:description", content: "ArtX is an independent studio designing, building and ranking standout websites for brands that refuse to blend in." },
          ...
          "@graph": [
            {
              ...
              description:
                "Independent studio designing, building and ranking standout websites.",
