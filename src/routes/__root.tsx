          ...
          "@graph": [
            {
              ...
              description:
                "ArtX is a full-service web design and development studio founded in 2016 in Bangladesh, offering website design, custom software, SEO, and security services to SaaS, e-commerce, and B2B brands worldwide.",
              ...
              contactPoint: {
                ...
                areaServed: ["BD", "US", "GB", "CA", "Worldwide"],
            ...
            },
            {
              ...
              areaServed: ["Dhaka", "Bangladesh", "Worldwide", "Remote"],
              address: {
                "@type": "PostalAddress",
