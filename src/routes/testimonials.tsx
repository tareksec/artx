...
const allTestimonials: TestimonialCard[] = [
  ...
  {
    qEn: "I always had questions about money and economics since childhood. Taking this course gave me the answers I was looking for—the live classes are even more lively than the books.",
    qBn: "ছোটবেলা থেকেই টাকা ও অর্থনীতি নিয়ে অনেক প্রশ্ন মাথায় ঘুরত, উত্তর পেতাম না। মোহাইমিন পাটোয়ারীর বই পড়ে এবং পরে কোর্সে ভর্তি হয়ে সেই প্রশ্নগুলোর উত্তর পেয়েছি — লাইভ ক্লাসগুলো বই থেকেও প্রাণবন্ত।",
    name: "Rabiul Hossain",
    roleEn: "Govt Employee, Defense Dept",
    roleBn: "সরকারি চাকুরিজীবী, প্রতিরক্ষা বিভাগ",
    rating: 5,
    radii: "rounded-tr-[2.5rem] rounded-bl-[2.5rem] rounded-tl-2xl rounded-br-2xl",
    projectSlug: "mohaimin-patwary",
    projectLinkEn: "Read the Course Platform case study",
    projectLinkBn: "কোর্স প্ল্যাটফর্ম কেস স্টাডি পড়ুন",
    industry: "Education",
  },
  {
    qEn: "This course is a platform that brings together concepts about economics, monetary systems, global trade, stock markets, and investment in one cohesive experience.",
    qBn: "এই কোর্সটা যেন অর্থনীতি, মুদ্রাব্যবস্থা, বিশ্ব বাণিজ্য, শেয়ারবাজার, কোম্পানি ও বিনিয়োগ সম্পর্কে ধারণাগুলো একসাথে মেলানোর একটা প্ল্যাটফর্ম।",
    name: "Abu Bakar Siddique",
    roleEn: "Advocate, Supreme Court",
    roleBn: "এডভোকেট, বাংলাদেশ সুপ্রিম কোর্ট",
    rating: 5,
    radii: "rounded-tl-[2.5rem] rounded-bl-[2.5rem] rounded-tr-2xl rounded-br-2xl",
    projectSlug: "mohaimin-patwary",
    projectLinkEn: "Read the Course Platform case study",
  ...
  {
    qEn: "Coming from a tech background, I always wondered how money circulates in business. This platform beautifully connects modern economics with Islamic finance.",
    qBn: "বিজ্ঞান ও প্রযুক্তির ব্যাকগ্রাউন্ড থেকে আসায়, ব্যবসার মধ্যে টাকার আবর্তন কীভাবে কাজ করে — এটা সবসময় প্রশ্ন ছিল। এই কোর্সে আধুনিক অর্থনীতির সঙ্গে ইসলামী অর্থনীতির একটা সুন্দর সংযোগ তুলে ধরা হয়েছে।",
    name: "Al Fahad",
    roleEn: "ECE Engineering, KUET",
    roleBn: "ইলেকট্রনিক্স ও কমিউনিকেশন ইঞ্জিনিয়ারিং, KUET",
    rating: 5,
    radii: "rounded-tr-[2.5rem] rounded-br-[2.5rem] rounded-tl-2xl rounded-bl-2xl",
    projectSlug: "mohaimin-patwary",
    projectLinkEn: "Read the Course Platform case study",
    projectLinkBn: "কোর্স প্ল্যাটফর্ম কেস স্টাডি পড়ুন",
    industry: "Education",
  ...
  {
    qEn: "One thing I enjoyed about the class was that the lecture was related to real-life problems. I now have a deeper insight into finance and the economy.",
    qBn: "One thing I enjoyed about the class was that the lecture was related to real-life problems. I now have a deeper insight into finance and the economy.",
    name: "Rakib Rahat",
    roleEn: "Course Student",
    roleBn: "কোর্স শিক্ষার্থী",
    rating: 5,
    radii: "rounded-tl-[2.5rem] rounded-br-[2.5rem] rounded-tr-2xl rounded-bl-2xl",
    projectSlug: "mohaimin-patwary",
    projectLinkEn: "Read the Course Platform case study",
